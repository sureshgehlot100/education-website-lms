...
// import { Link, userouterigate } from 'react-router-dom';
  ...
  return (
    ...
    <div className='bg-[#F5F7FF] w-full h-[100vh] flex justify-center items-center'>
      <div className='w-[500px]  bg-white px-[50px] py-[50px] '>
        <a href="#" className="flex items-center text-black text-2xl font-bold">
        ...
        <form action="">
          ...
          <Link href={'/'} ><input type="button" onClick={handleLogIn} value="Login" className='w-full bg-[#4B49AC] text-center text-[30px] text-white py-5 rounded-[18px] font-[arial]  font-[400]' /></Link>
